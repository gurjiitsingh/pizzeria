...
const tabs = [
  { name: "Dashboard", href: "/admin/sale/test/" },
  { name: "Items", href: "/admin/sale/test/" },
  { name: "New Item", href: "/admin/sale/test/new" },
  { name: "Sale", href: "/admin/sale/test/sale/add" },
  { name: "Adjust", href: "/admin/sale/test/daily-reports" },
  { name: "Transactions", href: "/admin/sale/test/transactions" },
  { name: "Categories", href: "/admin/sale/test/categories" },
  { name: "wholesaleCustomer", href: "/admin/sale/test/customer/all" },
];
...
export default function InventoryTabs() {
  ...
  const isProduction =
    pathname ===
    "/admin/sale/test/batchs";

  const isSale = pathname.startsWith(
    "/admin/sale/test/sale"
  );

  const isCustomer = pathname.startsWith(
    "/admin/sale/test/customer/all"
  );
  ...
  const isTransactions = pathname.startsWith(
    "/admin/sale/test/transactions"
  );

  const isAdjustStock = pathname.startsWith(
    "/admin/sale/test/daily-reports"
  );

  const isCustomerReturn = pathname.startsWith(
    "/admin/sale/test/customer/return"
  );

  const isEstimate =
  pathname === "/admin/sale/test/department";

  return (
  <div className="grid grid-cols-2 mt-1 mx-2  xl:grid-cols-9 gap-3">

  {/* <ActionCard
    href="/admin/sale/test/batchs"
    active={isProduction}
  ...
  {/* <ActionCard
    href="/admin/sale/test/department"
    active={isEstimate}
  ...
  <ActionCard
    ...
    description="Sale by Month"
    titleColor="text-gray-800"
    activeTitleColor="text-[#00897b]"
  />

  {/* <ActionCard
    href="/admin/sale/test/transactions"
  ...
  <ActionCard
    href="/admin/sale/test/daily-reports"
    ...
    title="Daily Reports"
    description="Sale per day"
    titleColor="text-gray-800"
    activeTitleColor="text-blue-700"
  />

  {/* <ActionCard
    href="/admin/sale/test/customer/all"
    active={isCustomer}
  ...
  {/* <ActionCard
    href="/admin/sale/test/customer/return"
