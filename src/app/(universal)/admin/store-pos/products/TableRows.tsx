...
const [showDescription, setShowDescription] = useState(false);
  ...
  className="flex items-center justify-center rounded-md hover:bg-orange-100 p-1 transition"
  title={
    isFeatured
      ? "Unmark as featured"
      : "Mark as featured"
...
>
  ...
  />
            ...
            <button
              ...
              className="flex items-center justify-center rounded-md hover:bg-blue-100 p-1 transition"
              title={
                isFavorite
        ...
        <TableCell>
          {product.taxRate !== undefined && product.taxRate !== null ? (
            <div className="flex flex-col">
              <span
                className={`text-[11px] text-[8px] px-1 py-[1px] rounded  w-fit ${product.taxRate
        ...
        <TableCell>
          <span
            className={`text-xs px-2 py-1 rounded-full capitalize font-semibold ${statusStyles[statusLabel as keyof typeof statusStyles] ||
